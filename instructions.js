...
let mainHeading = document.getElementById('heading')
 mainHeading.innerText = 'Javascript'
...
paragraph2.innerText = 'I have discovered that I can accomplish anything I put my mind to'
...
function multiply(x, y) {
   span1.innerText = input1.value * input2.value
...
function modulus() {
    span2.innerText = input3.value % input4.value
}
modulus()
...
bubbleTea.innerText = 'White Tea'
// 7.2 Change the text of 'Green Tea' to 'Black tea'
let greenTea = document.getElementsByClassName('greenTea')[0]
greenTea.innerText = 'Black Tea'
// 7.3 Change the text of 'Iced Tea' to 'Herbal Tea'
let iceTea = document.querySelector('[data-icedTea]')
iceTea.innerText = 'Herbal Tea'
